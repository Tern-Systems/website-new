...
describe(`Visual Regression Tests for ${Route.Courses} page`, () => {
    let browser: Browser;
    let page: Page;
    ...
    beforeAll(async () => {
        ...
        check = RegressionUtil.requireCheck(page, (Route.Courses + '/XXX') as Route);
    });
