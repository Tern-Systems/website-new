...
describe(`Visual Regression Tests for ${Route.Credentials} page`, () => {
    let browser: Browser;
    let page: Page;
    ...
    beforeAll(async () => {
        ...
        check = RegressionUtil.requireCheck(page, Route.Credentials + '/XXX');
    });
