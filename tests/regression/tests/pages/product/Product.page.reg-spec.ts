...
describe(`Visual Regression Tests for ${Route.Products} page`, () => {
    let browser: Browser;
    let page: Page;
    ...
    beforeAll(async () => {
        ...
        check = RegressionUtil.requireCheck(page, Route.Products);
    });
