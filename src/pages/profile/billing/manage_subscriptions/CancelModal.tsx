...
const CancelModal: FC<Props> = (props: Props) => {
    ...
    return (
        <BaseModal
            title={'Cancel Plan'}
            className={'bg-white [&_hr]:border-gray-l0 [&_h2]:text-gray [&_h2+button]:brightness-50 w-[90dvw] max-w-[33rem]'}
            classNameContent={'text-gray text-center text-basic'}
        >
            <div className={'inline-block max-w-[25rem]'}>
                <p className={'mb-xxs text-nowrap sm:max-w-[70%] sm:whitespace-pre-wrap place-self-center'}>
                ...
                <span
                    className={'flex gap-4xs font-bold mt-s text-section justify-center text-[#FFFFFF]'}>
                        <Button
                        ...
                        <PageLink href={Route.Billing}>
                            <Button className={`bg-gray-l0 ${BTN_CN}`}>
                                Return to Billing
                            </Button>
                        </PageLink>
                    </span>
