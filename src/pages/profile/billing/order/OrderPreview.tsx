...
const OrderPreview: FC<Props> = (props: Props) => {
    ...
    return (
        <div className={`relative shadow-2xl ${className}`}>
            <div className={'min-w-[min(100%,53rem)] px-[min(5.3dvw,6.6rem)] place-self-center'}>
                <div ref={targetRef}>
                    <h2 className={`mb-[min(10.7dvw,5.25rem)] font-bold text-header-l flex gap-[0.92rem] text-nowrap items-center`}>
