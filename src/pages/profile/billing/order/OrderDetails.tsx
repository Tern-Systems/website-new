...
const OrderDetailsComponent: ForwardRefRenderFunction<HTMLDivElement, PropsWithoutRef<Props>> = (
    ...
    return (
        <div className={`${className} bg-white px-s min-w-[min(100%,53rem)]`}>
            <div
                ref={ref}
                className={'w-[min(100%,29rem)] place-self-center py-n '}
            >
                <h2 className={'text-section-s font-bold  md:text-heading  lg:text-heading'}>Paid on {invoiceDate}</h2>

                <h3 className={'mt-l text-section-xs font-bold text-secondary  md:text-section-s  g:text-section-s'}>
                    Summary
                </h3>
                ...
                <h3 className={'mt-l text-section-xs font-bold text-secondary  md:text-section-s  lg:text-section-s'}>
                    Items
                </h3>
                {<Hr className='mt-4xs  md:mt-3xs  lg:mt-3xs' />}
                <div
                ...
                <div className={'grid grid-rows-2 gap-y-4xs text-section-xxs  md:text-section-xs  lg:text-section-xs'}>
