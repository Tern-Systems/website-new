            ...
            <div className={'relative z-10'}>
                        ...
                        <div>
                            <h1
                                className={cn(styles.textGlow,
                                    `w-min font-gothic font-bold text-right leading-[1.2]`,
                                    `mb-n text-[8rem]`,
                ...
                >
                    ...
                    <div
                        ...
                        <div className={cn(
                            ...
                            <div>
                                <h2 className={cn(
                                    'mb-xl font-gothic text-[4rem]  sm:x-[mb-xs,text-heading]',
                ...
                <section className={cn(styles.section, styles.fullHeightSection, 'relative')}>
                    <div className={cn(styles.content, 'flex flex-col py-[7rem] w-full justify-between  md:landscape:py-[1.875rem]  sm:landscape:py-[1.875rem]')}>
                        ...
                        <h1
                            className={cn(styles.textGlow,
                                `ml-auto w-min font-gothic font-bold text-right leading-[1.2] text-black`,
                                `mb-n text-[6rem]`,
