...
const AboutPage: FC = () => {
  return (
    <>
      ...
      <section
        className={cn(styles.section, styles.fullHeightSection, "relative")}
      >
        <div
          className={cn(
          ...
          >
            <div>
              ...
              <p
                className={cn(
                  "leading-tight",
                  "text-18 md:text-36 md:landscape:text-18 lg:text-40"
                )}
              >
                Revolutionize computing by harnessing the power of ternary
                microprocessors.
              </p>
            </div>
            <div>
              ...
              >
                Ushering in the era of efficient computing, equipping all legacy
                devices with advanced microprocessors.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="relative h-full">
        <div className="relative z-10 bg-black bg-gradient-to-b from-blue to-transparent to-60% md:to-35%  lg:x-[from-[-15%],to-20%]">
          ...
          />
          <InsideTernSection data={"alt1"} className={"bg-transparent"} />
        </div>
      </div>
    </>
  );
