...
const DocumentationPage: FC = () => {
    const Links: ReactElement[] = LINKS.map((link, idx) => (
        ...
        >
            <PageLink
                href={Route.Documentation + link.dynamicParam}
