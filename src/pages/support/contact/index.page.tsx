        ...
        <>
            ...
            <section
                className={cn(
                    styles.section,
                    'relative z-10',
                    'bg-black bg-gradient-to-b from-blue from-5% via-black via-30%',
                    'pb-[12.5rem] pt-6xl',
            ...
            >
                <div className={cn(styles.content)}>
                    <h2 className={'mb-[6.25rem] text-left text-heading-3xl font-bold sm:text-[2.5rem] md:text-[3rem]'}>
                        Get in Touch
                    </h2>
                    <form
            ...
            <section
                className={cn(
                    ...
                    'relative z-10',
                    'bg-gradient-to-t from-blue to-black',
                )}
            >
