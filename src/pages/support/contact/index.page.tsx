...
const INPUT_PROPS = {
  ...
  className: cn(
    "h-6xl w-full px-xxs ",
    "bg-gray-d2 border-s border-gray-l0",
    "text-primary"
  ),
};
        ...
        >
          <div className={cn("lg:w-1/2 md:w-[65%]")}>
            <div className={cn("")}>
              <h2
                className={cn(
                  "mb-6xl-1 text-left text-48 font-[500]",
                  "sm:mb-xl"
                )}
              >
                Get in Touch
              ...
              >
                <div className="grid gap-n">
                  ...
                  <Input
                    ...
                    isCustomCheckbox
                  >
                    May Tern provide you with personalized communications about
                    Tern and select Tern-partner products, services, offers and
                    events?
                  </Input>
                  <Button
                    type={"submit"}
