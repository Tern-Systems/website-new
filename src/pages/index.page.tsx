        ...
        >
            ...
            >
                <div className={'pb-4xs w-full bg-gradient-to-b from-transparent to-black'}>
                    <h4 className={cn(styles.textGlow, 'text-heading font-gothic font-bold')}>
                        {card.title}
                    </h4>
                </div>
            </div>
            ...
            <div className={'relative z-10'}>
                        ...
                        <div>
                            <h1
                                className={cn(styles.textGlow,
                                    `font-gothic text-center leading-[1.2]`,
                                    `mb-n text-[5.0625rem]`,
                                    `md:text-[3.4375rem]`,
                ...
                <section className={cn(styles.section, styles.fullHeightSection, 'sm:!h-fit')}>
                    ...
                    >
                        <h2
                            className={cn(styles.textGlow,
                                'font-bold font-gothic text-center text-[2.5rem] leading-[1.2] tracking-[0.1rem]',
                                'md:text-[1.75rem]',
                                'sm:text-[1.1875rem]',
                            )}
                        >
