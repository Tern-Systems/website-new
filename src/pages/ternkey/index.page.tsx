...
const TernKeyPage: FC = () => {
    ...
    const website: string | undefined = env === 'development' ? 'http://localhost:3001/' : process.env.NEXT_PUBLIC_WEBSITE;
    return (
        ...
        >
            ...
            <a href={userCtx.token ? `${website}ternkey/?website_login=${encodeURIComponent(userCtx.token || '')}` : website}
            target={'_blank'}
