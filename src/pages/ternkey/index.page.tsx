        ...
        <>
            <span className={cn(styles.highlight, 'flex-row gap-x-l')}>
                <span className={'flex flex-col justify-between'}>
                    <span className={'mr-auto text-[min(9.6dvw,3.75rem)] font-gothic font-bold'}>TernKey</span>
                    <span>
            ...
            >
                ...
                constructs.
                TernKey’s Emulator includes Input and Output Code Windows, enabling seamless transitions between Code
                ...
                community-focused Explore Keys Store feature fosters collaborative learning by allowing users to Share
                and explore Public Keys, making TernKey a comprehensive platform for advancing ternary programming and
                innovation.
