...
function TernKeyPage() {
    ...
    const TilesLi: ReactElement[] = TILES.map((tile, idx) => (
        <li
            key={tile.title + idx}
            className={'flex max-w-[13.75rem] flex-col text-section'}
        >
            <ReactSVG
                src={tile.image.src}
                className={'[&_*]:size-[6.25rem]  sm:[&_*]:x-[mx-auto,size-[2.5rem]]  md:[&_*]:size-[4.375rem]'}
            />
    ...
    const NewsLi: ReactElement[] = news.slice(0, RELATED_CARDS_COUNT - +isLg).map((article, idx) => (
        <ArticleCardLi
            key={article.id + idx}
            article={article}
        />
            ...
            <div className={'relative z-10'}>
                    ...
                    <div className={cn(styles.content, 'content-center')}>
                        <div className={'pb-6xl pt-5xl  sm:x-[pt-l,pb-5xl]'}>
                            ...
                            <Image
                                src={SVG_TERNKEY}
                                alt={'logo'}
                                className={'my-3xl h-auto w-[13.687rem]'}
                            />
                            <p className={'text-section-xl  lg:text-heading-xl'}>
                                Unlocking the potential of ternary programming
                            </p>
                            <div className={'mt-[2.31rem] flex flex-wrap gap-l text-nowrap text-heading-s'}>
                                <PageLink
                                    isExternal
                                    href={ternKeyUrl}
                ...
                >
                    <div
                        className={cn(
                            ...
                            'pb-[17rem] pt-6xl text-heading-xl',
                    ...
                    >
                        <h2
                            className={
                                'mx-auto w-2/3 text-center text-heading-3xl font-bold  leading-n  sm:text-heading  md:text-heading-xxl'
                            }
                        >
                            TernKey is the World’s First Ternary Software Stack
                        </h2>
                        <p className={'mt-[6rem]  sm:mt-xxl'}>
                            We are driving the evolution from binary to ternary computing. By harnessing the superior
                            data density and efficiency of ternary logic, TernKey provides developers with an innovative
                        ...
                        <div className={'contents'}>
                            <Image
                                ...
                                alt={'emulator sample'}
                                className={'my-[7.56rem] h-auto  w-full  sm:my-xxl  md:my-[6rem]'}
                            />
                        </div>
                        <p>
                ...
                >
                    <div
                        className={cn(
                            ...
                            'relative z-10 py-6xl text-heading-xl leading-n',
                        )}
                    >
                        {/* TODO style according to figma*/}
                        <iframe
                            allowFullScreen
                            src={MISC_LINKS.TernKeyDemoEmbed}
                            title={'TernKey demo'}
                            allow={
                                'accelerometer; autoplay; clipboardwrite; encryptedmedia; gyroscope; pictureinpicture; webshare'
                            }
                            referrerPolicy={'strict-origin-when-cross-origin'}
                            className={'h-[50dvw] max-h-[42.886rem] w-full'}
                        />
                    </div>
                </section>
                <section className={styles.section}>
                    <div
                        className={cn(
                            styles.content,
                            'relative z-10 grid grid-cols-2 gap-x-5xl py-6xl  leading-n  sm:grid-cols-1',
                        )}
                    >
                        <div className={'contents'}>
                            <Image
                        ...
                        <div className={'sm:contents'}>
                            <h2
                                className={
                                    'text-heading-3xl font-bold  leading-n  sm:x-[row-start-1,mb-xs,text-center,text-documentation]  md:text-heading-xl'
                                }
                            >
                                Turning Heads
                            </h2>
                            <p
                                className={
                                    'mt-xxl text-heading-xl  sm:x-[mx-auto,mt-xs,w-2/3,text-basic]  md:text-heading'
                                }
                            >
                ...
                <section className={styles.section}>
                    <div
                        className={cn(
                            styles.content,
                            'grid max-h-min grid-cols-[1fr,1fr,max-content] gap-y-5xl py-7xl leading-n',
                            'text-basic',
                            'lg:text-section-s',
                    ...
                    >
                        <h2
                            className={
                                'col-span-3 text-center text-heading-3xl  font-bold leading-n  sm:x-[col-span-1,text-heading]  md:text-heading-l'
                            }
                        >
                            Learning Together
                        </h2>
                        <p className={'sm:text-center'}>
                            ...
                            <span className={'mt-5xs block'}>
                                TernKey enhances developer collaboration through Explore Keys, a comprehensive database
                                of TernKey programs, known as Keys. This platform connects users with software
                                developers globally, fostering an open and dynamic environment for learning, sharing,
                                and growth.
                            </span>
                            <PageLink
                                isExternal
                        ...
                        <div className={'contents'}>
                            <Image
                                ...
                                alt={'globe glass'}
                                className={
                                    'col-start-3 ml-auto mt-auto h-[13.5rem]  w-auto  sm:x-[row-start-2,col-start-1,ml-0]'
                                }
                            />
                        </div>
                    </div>
                ...
                <section className={styles.section}>
                    <div className={cn(styles.content, 'py-6xl')}>
                        <h2
                            className={'text-heading-xl  font-bold  sm:x-[text-center,text-heading]  md:text-heading-l'}
                        >
                            Features
                        </h2>
                        <ul className={'mx-auto mt-5xl grid w-fit grid-cols-3  gap-3xl  sm:grid-cols-1  lg:w-full'}>
                            {TilesLi}
                        </ul>
                    </div>
                </section>
                <section className={styles.section}>
                    <div className={cn(styles.content, 'py-5xl')}>
                        <h2 className={'text-heading-3xl  font-bold  sm:text-heading  md:text-heading-xl'}>
                            Latest News
                        </h2>
                        {!NewsLi.length ? (
                            <span className={'mt-xs block text-section-xs'}>Can&apos; fetch news</span>
                        ) : (
                            <ul
                                className={
                                    'mx-auto mt-5xl grid w-fit grid-cols-3  gap-3xl  sm:grid-cols-1  md:grid-cols-2  lg:w-full'
                                }
                            >
                                {NewsLi}
                            </ul>
