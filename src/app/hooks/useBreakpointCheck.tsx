...
const useBreakpointCheck = () => {
    ...
    useEffect(() => {
        const handleResize = () => {
            ...
            else if (BREAKPOINT.xxs.min <= innerWidth && innerWidth < BREAKPOINT.xxs.max) setBreakpoint(Breakpoint.xxs);
            else if (BREAKPOINT.xs.min <= innerWidth && innerWidth < BREAKPOINT.xs.max) setBreakpoint(Breakpoint.xs);
            else if (BREAKPOINT.sm.min <= innerWidth && innerWidth < BREAKPOINT.sm.max) setBreakpoint(Breakpoint.sm);
