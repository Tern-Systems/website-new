...
const SubNavElement = (props: Props, ref: ForwardedRef<HTMLDivElement>) => {
        ...
        useEffect(() => {
            const handleClick = (event: MouseEvent) => {
                if (subNavRef && !subNavRef?.current?.contains(event.target as Node))
                    ...
                    return (
                        <li
                            ...
                            className={cn(
                                ...
                                breakpoint <= Breakpoint.xxs ? 'px-s first-of-type:font-bold' : 'first-of-type:x-[mb-5xs,text-documentation]',
                            )}
                        >
                            <PageLink
                                onClick={async () => {
                                ...
                                iconClassName={cn('ml-4xs', breakpoint <= Breakpoint.xxs ? '[&_*]:!size-[0.8rem]' : '!size-[1.6rem]')}
                            >
                                {title}
                            </PageLink>
                        </li>
            ...
            const BackBtn: ReactElement = (
                ...
                >
                    <Button
                        ...
                        icon={'chevron'}
                        className={'p-s border-b-s font-bold !justify-start'}
                    ...
                    return (
                        <li
                            ...
                            className={cn('group', stylesLayout.navLink, {
                                    [cn(stylesLayout.activeNavLink, 'before:bg-blue')]: isActiveCN && breakpoint > Breakpoint.xxs,
                                },
                            )}
                        >
                            {dropdownLinks
        ...
        return (
            <>
                    ...
                    : (
                        <div
                            ...
                            className={cn(styles.section,
                                'absolute z-[1000] left-0 bg-black-l0',
                            ...
                            <ul
                                className={cn(styles.content,
                                    ...
                                    breakpoint <= Breakpoint.xxs
                                        ...
                                        : 'gap-xs justify-between flex-wrap',
                                )}
                            >
                                {DropdownLi}
                            </ul>
                ...
                {!subNavLinks?.length || breakpoint <= Breakpoint.xxs
                    ? null
                    : (
