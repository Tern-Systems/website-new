            ...
            const LinksLi: ReactElement[] = entries.map(([title, action], entryIdx) => {
                ...
                return (
                    <li
                        ...
                        className={cn(
                            'first-of-type:x-[mb-5xs,text-documentation] first-letter:uppercase',
        ...
        <>
            {!DropdownLi
                ...
                : (
                    <div
                        ref={subNavRef}
                        className={cn(styles.section, 'absolute z-[1000] left-0 h-fit bg-black-l0',
                            'py-4xl',
                            'sm:x-[min-w-0,w-[79%]]',
                            `xxs:x-[gap-x-l,max-w-[14.5625rem],overflow-y-scroll,bg-gray-d0] xxs:top-[calc(1px+var(--h-heading))] xxs:h-[calc(100dvh-var(--h-heading))]`,
                        )}
                    >
                        <ul
                            className={cn(styles.content, 'flex',
