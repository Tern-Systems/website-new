...
const PricingAndPlansScreen: FC<Props> = (props: Props) => {
  ...
  const renderColumn = (
    ...
    const CollapsedContentSm = (
      <>
        <h2
          className={`flex items-center mb-[--1dr] font-oxygen text-header font-bold capitalize
    ...
    return (
      ...
      >
        {CollapsedContentSm}
        <ul
          className={`flex flex-col gap-[min(5.3dvw,1.5rem)] mt-[min(5.3dvw,1.5rem)] items-start
                                text-default
  ...
  return (
    <div
      className={`flex flex-col gap-[min(5.3dvw,3.12rem)] my-auto
                        sm:my-0
                        sm:landscape:flex-row`}
    >
      <div
        className={`flex place-self-center p-[0.2rem] border-small rounded-full text-small
      ...
      <div
        className={
          "flex place-self-center gap-[min(2.6dvw,4.13rem)] sm:portrait:flex-col"
        }
      >
        {renderColumns()}
      </div>
