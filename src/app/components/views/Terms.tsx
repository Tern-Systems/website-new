...
Agreement Overview This document outlines the Terms and Conditions ("Terms") governing the use of the Tern Systems LLC website, accessible at <a href='https://www.tern.ac' target="_blank" class="underline">www.tern.ac</a> (the "Site"). By accessing or using the Site, you agree to comply with these Terms without modification. If you do not agree, please refrain from using the Site. A copy of these Terms is recommended for your records.

About Tern Systems LLC and the Site Tern Systems LLC ("Tern Systems") develops, manufactures, and enhances computer software and hardware with a focus on universal process efficiency. The Site provides users with information about our services and offerings.
...
const TermsView = () => (
    <div className={`${styles.highlight} max-w-[112.25rem] max-h-[41.625rem]`}>
        <h1 className={'mb-[2.3rem]'}>Terms & Conditions</h1>
        <span className={'overflow-y-scroll [&&]:text-[1.6875rem]'}>
            <pre className={'font-neo'}>{PARAGRAPHS}</pre>
        </span>
    </div>
);
