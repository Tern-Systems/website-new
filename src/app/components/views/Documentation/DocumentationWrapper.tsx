...
const ViewDict: Record<string, { elem: () => JSX.Element, anchors: TListEntry, isChapter: boolean }> = {
    ...
    [SectionsEnum.UserManual]: COMMING_SOON_DOC,
    [SectionsEnum.ARCHManual]: COMMING_SOON_DOC,
    [SectionsEnum.TernKitManual]: COMMING_SOON_DOC,
    [SectionsEnum.BTMCHandbook]: COMMING_SOON_DOC,
    [SectionsEnum.TernHandbook]: COMMING_SOON_DOC,
}
...
const DocumentationWrapper = (props: IDocumentationViewProps) => {
    const {view} = props;
