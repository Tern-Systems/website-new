    ...
    return (
        <div className={styles.content}>
            <div className={styles.text}>
                ...
                <p>
                    Life-cycle, memory instructions, blah blah blah and some history stuff about how the language came
                    to be created. built T27I first. Do not talk about the history of ternary computers or logic or any
                ...
                <br/>
                <p>
                    TernKey features a cutting-edge high-level programming language called G, which resembles C in terms
                    of structure. It leverages Backus-Naur Form notation and shares syntax and semantic rules similar to
                ...
                <p>
                    ...
                    traditional ternary operations by accommodating three-dimensional evaluation of conditions, thereby
                ...
                <p>
                    ...
                    annotations for the programmer or anyone reviewing the code. Comments may appear anywhere a blank,
                    tab or newline can. Comments are ignored by the compiler and do not affect the program’s execution.
                    G supports two types of comments: single-line and multi-line.
                </p>
                <br/>
                <p>
                    Single-line comments begin with two forward slashes // and continue until the end of the line. They
                    are typically used for brief explanations or to disable a single line of code during debugging or
                    testing.
                </p>
                <br/>
                <p>
                    Multi-line comments start with /* and end with */. These comments can span multiple lines, making
                ...
                <p>
                    ...
                    especially important in collaborative environments where multiple developers might work on the same
                ...
                <br/>
                <p>
                    The single-line delimiter symbol, depicted by the // token, is used exclusively to insert comments
                ...
                <p>
                    ...
                    content to the right of each single-line comment delimiter symbol token // as long as it is on the
                    same line.
                </p>
                <br/>
                <p>
                    In this example, we declare an integer variable a with the value 5. In balanced ternary, the number
                    5 is represented as 000000+--. We then define another integer variable, b, with the value 2. The
                    result variable is uninitialized. This tells the program to shift the terts of a to the left by 2
                    positions. The left shift state operator &qt;&qt; works by moving the terts of the balanced ternary
                    number to the left by the specified number of positions and filling the rightmost terts with zeros;
                    in our case, shifting 000000+-- by 2 positions to the left results in 0000+--00, equivalent to the
